...
/**
 * @description
 * Get all collection by database link
 * @param db
 * @param {Object=} options
 * @returns {Promise}
 */
function getAllCollections(db, options) {
  return new Promise(function(resolve, reject) {
 ...
 * @returns {Promise}
 */
function getAllDocuments(col, options) {
  return new Promise(function(resolve, reject) {
    clientDB.readDocuments(col._self, options).toArray(function(err, results) {
      return err
        ? reject(new Error(err))
        : resolve(results);
    });
